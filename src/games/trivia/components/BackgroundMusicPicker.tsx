...
import { audio, BACKGROUND_TRACKS, type BackgroundTrackId } from '../../../platform/audio/audio';
import { MUSIC_GAIN_MAX, musicGainToSlider, musicSliderToGain } from '../../../platform/audio/musicVolumePolicy';
