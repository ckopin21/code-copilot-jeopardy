...
import { calculateComebackAward, comebackBoostsUnlocked } from '../../src/games/trivia/rules/comebackScoring';
...
function selectValue(engine: TriviaEngine, roomCode: string, hostToken: string, playerId: string, value: number) {
...
function completeCorrectTurn(engine: TriviaEngine, roomCode: string, hostToken: string, playerId: string) {
...
function unlockComebacks(engine: TriviaEngine, roomCode: string, hostToken: string, playerIds: string[]) {
